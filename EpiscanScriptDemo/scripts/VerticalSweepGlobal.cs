...
public class VerticalSweepGlobalScript : IEpiscanScript
{
    public int Left { set; get; } = 0;
    public int Right { set; get; } = 1280;
    public int XShift { set; get; } = 100;
    public int LineWidth { set; get; } = 100;
    public int DelayMin { set; get; } = 10200;
    public int DelayMax { set; get; } = 30600;
    public int Shift { set; get; } = 170;
    public float Exposure { set; get; } = 0.850f;
