...
namespace HelperCamUtil
{
    public class HelperSensor
    {
        ...
        private double _minFR = 0, _maxFR = 0, _incFR = 0;
        ...
        public HelperSensor(int deviceId = -1)
        {
            InitCamera(deviceId);
        }
        public HelperSensor(IntPtr handle, int deviceId = -1)
        {
        ...
        {
            get => PixelFormat == PixelFormatList_h.Mono8 || PixelFormat == PixelFormatList_h.BGR24;
        }
        public bool IsMono
        {
            get => PixelFormat == PixelFormatList_h.Mono8 || PixelFormat == PixelFormatList_h.Mono12;
        }
        public bool IsBayer
        {
            get => PixelFormat == PixelFormatList_h.Bayer12;
        }
        ...
        private void InitCamera(int deviceId = -1)
        {
            ...
            this._camera.Timing.Framerate.GetFrameRateRange(out _minFR, out _maxFR, out _incFR);
        ...
        {
            // color mode
            var isMono = PixelFormat == PixelFormatList_h.Mono8
                || PixelFormat == PixelFormatList_h.Mono12
                || PixelFormat == PixelFormatList_h.Bayer12;
        ...
        public double FrameRate
        {
            set
            {
                double actualFR = value;
                if (value < this._minFR) actualFR = this._minFR;
                else if (value > this._maxFR) actualFR = this._maxFR;

                uEye.Defines.Status stat = _camera.Timing.Framerate.Set(actualFR);
                if (stat != uEye.Defines.Status.Success) throw new Exception("failed to set framerate.");
                OnSensorParameterChanged();
            }
            get
            {
                double value;
                uEye.Defines.Status stat = _camera.Timing.Framerate.Get(out value);
                if (stat != uEye.Defines.Status.Success) throw new Exception("failed to get framerate.");
                return value;
            }
        }
        ...
        private PixelFormatList_h pixelFormat = PixelFormatList_h.Undefined;
        public PixelFormatList_h PixelFormat
        {
            get
            {
                ...
                if (pixelFormat != PixelFormatList_h.Undefined) return pixelFormat;
                switch (cm)
                {
            ...
            set
            {
                ...
                switch (value)
                {
                    ...
                    case PixelFormatList_h.BGR36: cm = uEye.Defines.ColorMode.BGR12Unpacked; break;
                    case PixelFormatList_h.Bayer12: cm = uEye.Defines.ColorMode.SensorRaw12; break;
                    default:
